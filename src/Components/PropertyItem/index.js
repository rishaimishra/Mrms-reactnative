...
import {deleteProperty, insertIfNotExists, updateProperty,loadPropertiesInList} from '../../database/Property';
...
class PropertyItem extends Component {
    ...
    onRequestNavigation = () => {
     ...
     onDelete =async () => {
        ...
        deleteProperty(item.serverPropertyId)
        loadPropertiesInList(1);
        this.props.onLoad();
        //this.props.navigation.popToTop();

        // alert(item.serverPropertyId)
    }
    shouldComponentUpdate(nextProps) {
        ...
        || item.ownerTitle !== nextProps.item.ownerTitle
    ...
    openLocation = openLocationCode.encode(coord[0],coord[1]);
        ...
        let imageSource = item.assessmentPropertyPhoto1 ? {uri: item.assessmentPropertyPhoto1} : this.state.placeholder;
       
       if(imageSource.toString().length<2){
        console.log("ok ");

        imageSource=this.state.placeholder;
       }
...
console.log("imageSource1 "+imageSource);
        return (
            <View
                style={[
            ...
            >
                ...
                >
                    ...
                    <Image
                    style={styles.image}
                    source={imageSource.uri?imageSource:require('../../assets/placeholder.png')}
                        style={{flex: 1}}
                    />
                ...
                {/* <TouchableOpacity
                    ...
                    <Icon size={20} name={'delete'} style={{color:'red',position:"relative"}}/>
</View>
                </TouchableOpacity> */}
