...
class OccupancyDetails extends PureComponent {
    ...
    onChangeMobile1 = text => this.props.setPropertyField('tenantMobile1', text.replace(/[- #*;,.N()<>\{\}\[\]\\\/]/gi, ''));
    onChangeMobile2 = text => this.props.setPropertyField('tenantMobile2', text.replace(/[- #*;,.N()<>\{\}\[\]\\\/]/gi, ''));
    onChangeTitle = text => this.props.setPropertyField('ownerTenantTitle', text);
