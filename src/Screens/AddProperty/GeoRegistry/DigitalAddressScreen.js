...
class DigitalAddressScreen extends PureComponent {
    ...
    validatorMandatory = () => {
        ...
        let mandatoryFields = {
            ...
            'propertyStreetNumber': 'Old Property Street Number',
            'propertyStreetNumbernew': 'New Property Street Number',
            ...
            'assessmentWindowType' : 'Window Type',
        ...
        return (
            ...
            >
                ...
                <View style={styles.bottom}>
                    ...
                    {serverPropertyId && isDraftDelivered && (
                        <>
                            ...
                            <TextInput
                                ...
                                onChangeText={text => this.props.setPropertyField('deliveryPersonMobile', text.replace(/[- #*;,.N()<>\{\}\[\]\\\/]/gi, ''))}
                    ...
                    <View style={{height: 60}}>
                        <Checkbox
                            label="Save as Complete - All data Captured"
                            value={1}
                            checked={isCompleted}
                    ...
                    />
                    <ActivityLoader text={'Updating...'} loading={this.state.updating}/>
                </View>
            </ScrollView>
        );
    }
